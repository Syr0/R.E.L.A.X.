...
const TRANSLATIONS: Record<string, Record<string, string>> = {
	...
	es: { add_group: "Añadir grupo", add_regex: "Añadir Regex", add_single_regex: "Regex único", del_group: "✕", desc_key: "Descripción", regexp: "Regexp", unnamed_group: "Grupo sin nombre", blacklist: "Lista negra", blacklist_placeholder: "Añadir término...", add: "Añadir", blacklist_empty: "Vacío.", ignore_links: "Ignorar enlaces", ignore_urls: "Ignorar URLs", defang_urls: "Desactivar URLs", ignore_code: "Ignorar código", remove_unresolved: "Solo no resueltos", reset: "Restablecer", apply_relax: "Aplicar R.E.L.A.X.", remove_all: "Quitar paréntesis", invalid_regex: "Inválido.", multiple_groups: "Máx. 1 grupo.", lang: "Idioma" },
	...
	pt: { add_group: "Adicionar grupo", add_regex: "Adicionar Regex", add_single_regex: "Regex único", del_group: "✕", desc_key: "Descrição", regexp: "Regexp", unnamed_group: "Grupo sem nome", blacklist: "Lista negra", blacklist_placeholder: "Adicionar termo...", add: "Adicionar", blacklist_empty: "Vazio.", ignore_links: "Ignorar links", ignore_urls: "Ignorar URLs", defang_urls: "Neutralizar URLs", ignore_code: "Ignorar código", remove_unresolved: "Remover apenas não resolvidos", reset: "Redefinir", apply_relax: "Aplicar R.E.L.A.X.", remove_all: "Remover parênteses", invalid_regex: "Inválido.", multiple_groups: "Máx. 1 grupo.", lang: "Idioma" },
	...
	sv: { add_group: "Lägg till grupp", add_regex: "Lägg till Regex", add_single_regex: "Enskild Regex", del_group: "✕", desc_key: "Beskrivning", regexp: "Regexp", unnamed_group: "Namnlös grupp", blacklist: "Svartlista", blacklist_placeholder: "Lägg till term...", add: "Lägg till", blacklist_empty: "Tom.", ignore_links: "Ignorera länkar", ignore_urls: "Ignorera URLs", defang_urls: "Neutralisera URLs", ignore_code: "Ignorera kod", remove_unresolved: "Ta endast bort olösta", reset: "Återställ", apply_relax: "Tillämpa R.E.L.A.X.", remove_all: "Ta bort parenteser", invalid_regex: "Ogiltig.", multiple_groups: "Max 1 grupp.", lang: "Språk" },
	da: { add_group: "Tilføj gruppe", add_regex: "Tilføj Regex", add_single_regex: "Enkelt Regex", del_group: "✕", desc_key: "Beskrivelse", regexp: "Regexp", unnamed_group: "Unavngiven gruppe", blacklist: "Sortliste", blacklist_placeholder: "Tilføj ord...", add: "Tilføj", blacklist_empty: "Tom.", ignore_links: "Ignorer links", ignore_urls: "Ignorer URLs", defang_urls: "Neutraliser URLs", ignore_code: "Ignorer kode", remove_unresolved: "Fjern kun uløste", reset: "Nulstil", apply_relax: "Anvend R.E.L.A.X.", remove_all: "Fjern parenteser", invalid_regex: "Ugyldig.", multiple_groups: "Maks 1 gruppe.", lang: "Sprog" },
	fi: { add_group: "Lisää ryhmä", add_regex: "Lisää Regex", add_single_regex: "Yksittäinen Regex", del_group: "✕", desc_key: "Kuvaus", regexp: "Regexp", unnamed_group: "Nimetön ryhmä", blacklist: "Musta lista", blacklist_placeholder: "Lisää termi...", add: "Lisää", blacklist_empty: "Tyhjä.", ignore_links: "Ohita linkit", ignore_urls: "Ohita URL-osoitteet", defang_urls: "Neutralisoi URL-osoitteet", ignore_code: "Ohita koodi", remove_unresolved: "Poista vain ratkaisemattomat", reset: "Nollaa", apply_relax: "Käytä R.E.L.A.X.", remove_all: "Poista sulkeet", invalid_regex: "Virheellinen.", multiple_groups: "Enintään 1 ryhmä.", lang: "Kieli" },
	no: { add_group: "Legg til gruppe", add_regex: "Legg til Regex", add_single_regex: "Enkelt Regex", del_group: "✕", desc_key: "Beskrivelse", regexp: "Regexp", unnamed_group: "Unavngitt gruppe", blacklist: "Svarteliste", blacklist_placeholder: "Legg til ord...", add: "Legg til", blacklist_empty: "Tom.", ignore_links: "Ignorer lenker", ignore_urls: "Ignorer URLs", defang_urls: "Nøytraliser URLs", ignore_code: "Ignorer kode", remove_unresolved: "Fjern kun uløste", reset: "Nullstill", apply_relax: "Bruk R.E.L.A.X.", remove_all: "Fjern parenteser", invalid_regex: "Ugyldig.", multiple_groups: "Maks 1 gruppe.", lang: "Språk" },
	cs: { add_group: "Přidat skupinu", add_regex: "Přidat Regex", add_single_regex: "Samostatný Regex", del_group: "✕", desc_key: "Popis", regexp: "Regexp", unnamed_group: "Nepojmenovaná skupina", blacklist: "Blacklist", blacklist_placeholder: "Přidat termín...", add: "Přidat", blacklist_empty: "Prázdné.", ignore_links: "Ignorovat odkazy", ignore_urls: "Ignorovat URL", defang_urls: "Neutralizovat URL", ignore_code: "Ignorovat kód", remove_unresolved: "Odstranit pouze nevyřešené", reset: "Resetovat", apply_relax: "Použít R.E.L.A.X.", remove_all: "Odstranit závorky", invalid_regex: "Neplatný.", multiple_groups: "Max 1 skupina.", lang: "Jazyk" },
	hu: { add_group: "Csoport hozzáadása", add_regex: "Regex hozzáadása", add_single_regex: "Egyedi Regex", del_group: "✕", desc_key: "Leírás", regexp: "Regexp", unnamed_group: "Névtelen csoport", blacklist: "Tiltólista", blacklist_placeholder: "Kifejezés hozzáadása...", add: "Hozzáadás", blacklist_empty: "Üres.", ignore_links: "Linkek figyelmen kívül hagyása", ignore_urls: "URL-ek figyelmen kívül hagyása", defang_urls: "URL-ek hatástalanítása", ignore_code: "Kód figyelmen kívül hagyása", remove_unresolved: "Csak a feloldatlanok törlése", reset: "Visszaállítás", apply_relax: "R.E.L.A.X. alkalmazása", remove_all: "Zárójelek eltávolítása", invalid_regex: "Érvénytelen.", multiple_groups: "Max 1 csoport.", lang: "Nyelv" },
